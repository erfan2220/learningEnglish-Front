...
const CourseDetail = ({ courseId }: { courseId: string }) => {
  const matchData = courseMockDetail.find(
    (matchData) => courseId === matchData.courseId
  );

  const matchTutor = tutorMockDetail.find(
          ...
          <div className="p-4 sm:p-12">
            ...
            <div className="flex flex-wrap my-4 gap-3 text-[#45444A] font-bold text-sm">
              <div className="px-3 py-1 bg-[#D2C3FF] rounded-3xl shadow">
                <Country
                  flag={matchData?.courseLanguageFlag}
                  countryName={matchData?.courseLanguage ?? ""}
                  fontWeight={"semibold"}
                  textSize="14px"
                  width={22}
                />
              ...
              <div className="flex gap-1 px-3 py-1 bg-[#D2C3FF] rounded-3xl shadow">
                <Image
                  ...
                  height={22}
                />
                <p>{matchData?.courseCapacity} spots / class</p>
              </div>
            </div>
            ...
            <div className="my-8 mt-10 text-[#45444A]">
              ...
              <p className="text-[#737177]">{matchData?.courseDescription}</p>
            </div>
            {/* ///////Read more////////////// */}
            ...
            <div className="my-8 text-[#45444A]">
              ...
              <p className="text-[#737177]">
                <b>{matchData?.courseDuration}</b> Lessons
              </p>
            </div>
          </div>
        </Layout>
