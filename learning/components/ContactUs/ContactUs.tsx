...
const contactUsImage = "/images/contactUs.svg";
const ContactUs = () => {
  return (
    <div className="p-2 pt-6 md:p-12 max-w-[1320px] mx-auto">
      ...
      <div className="mt-[60px] ">
        <Layout marginTop="mt-8">
          <h1 className="text-[#45444A] text-2xl sm:text-3xl p-6 sm:p-12 pb-0 sm:pb-0 font-bold">
            Contact Us
          </h1>
          <div className="w-full flex items-center p-6 sm:p-12 sm:pt-8">
            <div className="w-full lg:w-2/3  text-sm sm:text-base text-[#5C5A60] leading-[30px]">
              <p className="mb-4">
                ...
                skills, a teacher wanting to collaborate, or just have a
                question about our services, our team is here to help.
              </p>
              ...
              <p>
                ...
                the latest updates, tips, and learning resources. Your journey
                to becoming a confident language learner starts here!
              </p>
            </div>
            <div className="hidden lg:block md:w-1/3 text-sm sm:text-base text-[#5C5A60] leading-[30px]">
              <Image
                src={contactUsImage}
                alt="contact"
                width={500}
