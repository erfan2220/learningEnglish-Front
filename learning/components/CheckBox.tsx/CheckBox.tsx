        ...
        >
          <input
            ...
            className="peer relative h-5 w-5 cursor-pointer appearance-none rounded border border-slate-300 shadow hover:shadow-md transition-all
             ...
             before:rounded-full before:bg-lime-400 before:opacity-0 before:transition-opacity 
             checked:border-lime-600 checked:bg-lime-500 checked:before:bg-lime-300 hover:before:opacity-10"
          />
          <span
            className="pointer-events-none absolute top-2/4 left-2/4 
            -translate-y-2/4 -translate-x-2/4 text-white opacity-0 transition-opacity 
