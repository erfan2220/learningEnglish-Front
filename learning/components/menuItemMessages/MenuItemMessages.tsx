...
const MenuItemMessages = ({ role }: { role: string }) => {
  ...
  return (
    <div className="w-full">
      ...
      {openMenu && (
        <div className="w-[90%] ml-2 flex flex-col justify-center items-center rounded-lg -mt-0.5 py-2 bg-[#e7e0fd70] z-1 shadow-inner">
          <DashboardMenuItems
            role={role}
