...
export default function LanguageList({
    ...
    return (
        <div className="flex flex-col gap-2">
            {value.map((lang, idx) => (
                <div key={idx} className="flex w-full items-center gap-2">
                    <div className="w-full">
                        <label className="text-xs mx-2 mt-2 text-[#45444A]">Language you speak</label>
                        <div className="relative">
                            ...
                            <Image src={languageIcon} alt="language icon" width={20} height={20} className="absolute top-[12px] left-4" />
                        </div>
                    </div>
            ...
            <button type="button" onClick={add} className="text-[#45444A] font-bold underline w-fit">
                + Add Language
            </button>
        </div>
    );
