...
function useLocalStorage<T>(key: string, initialValue: T) {
  ...
  useEffect(() => {
    if (typeof window === "undefined") return;
    try {
      const toStore = typeof value === "string" ? (value as string) : JSON.stringify(value);
      ...
      <div className="py-2 pt-6 md:py-12">
        <div className="mt-[60px]">
          ...
          <div className="flex flex-col justify-start text-sm sm:text-base text-[#737177] items-start gap-4 mt-10 bg-white/70 max-w-xl mx-auto w-full p-6 rounded-2xl">
            ...
            <p>
              Tell learners about yourself and start building your public tutor profile. Your progress is saved as you go,
              so feel free to return anytime to continue.
            </p>
