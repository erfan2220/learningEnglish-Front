  ...
  return (
    <div className="relative min-w-[200px] mx-2 my-1 flex-shrink-0">
      <select
        ...
        className="w-full appearance-none border-2 border-[#D2D2D2] focus:border-[#5F33E1] top-1/2 rounded-2xl pl-10 pr-10 py-3 bg-white/80 text-sm h-11 focus:outline-0"
      >
