...
// import { isAxiosError } from "axios"; // ✅ for safe error narrowing
//
...
//                     >
//                         {/* ✅ use /public asset path, no import */}
...
export default function GlobalLoader() {
    const isLoading = useAppSelector((s) => s.loading.global);

    console.log("loading2222",isLoading);
